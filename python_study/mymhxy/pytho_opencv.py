...
def runAllImageSimilaryFun(para1, para2):
    ...
    if para1.startswith("http"):
        ...
        # 通过imread方法直接读取物理路径
        p1="F:\\lz\\svn_work\\python_study_branch\\mymhxy\\object\\capture\\052.object_吉里吉里.259_466_355_586_20_20200215033646331.png"
        p2="F:\\lz\\svn_work\\python_study_branch\\mymhxy\\object\\052.object_吉里吉里.259_466_355_586_20.bmp"
        img1 = Image.open(p1)
        #imagexx.show()
        img2 = Image.open(p2)
        #img1 = cv2.imread("052.png")
        #img2 = cv2.imread("052x.bmp")
        img1 = cv2.cvtColor(np.asarray(img1), cv2.COLOR_RGB2BGR)
        img2 = cv2.cvtColor(np.asarray(img2), cv2.COLOR_RGB2BGR)
